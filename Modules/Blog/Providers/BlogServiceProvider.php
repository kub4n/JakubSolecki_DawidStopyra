...
use Modules\Blog\Repositories\Cache\CacheReservationDecorator;
use Modules\Blog\Repositories\Eloquent\EloquentPostRepository;
use Modules\Blog\Repositories\Eloquent\EloquentReservationRepository;
...
class BlogServiceProvider extends ServiceProvider
{
    ...
    private function registerBindings()
    {
        ...
        $this->app->bind(ReservationRepository::class, function () {
            ...
            return new CacheReservationDecorator($repository);
        });
    }
