...
class Post extends Model implements TaggableInterface
{
    ...
    public $translatedAttributes = ['title', 'slug', 'content', 'location', 'address', 'numberOfPlaces', 'rezervation_date', 'closest_term'];
    protected $fillable = ['category_id', 'user_id', 'status', 'title', 'slug', 'content', 'location', 'address', 'numberOfPlaces', 'rezervation_date', 'closest_term'];
